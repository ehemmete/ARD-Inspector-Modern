...
This app allow for reading the Apple Remote Desktop (ARD) preferences file.  I've used it primarily to get the passwords that are saved behind the ARD Master Password.  
